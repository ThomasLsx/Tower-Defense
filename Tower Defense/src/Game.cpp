      ...
      m_bRequestStartWave(false)
{
    ...
    // initialize towers
    towerManager.addTower(sf::Vector2f(300.f, 300.f), 3); // 0 correspond à BasicTower (enum)
    towerManager.addTower(sf::Vector2f(500.f, 400.f), 3); // 2 correspond à SpeedTower
